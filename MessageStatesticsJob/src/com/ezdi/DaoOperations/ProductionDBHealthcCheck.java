...
public class ProductionDBHealthcCheck extends Thread {
	...
	public void run() {
		...
		try {
			...
			Connection connection = UtilityClass
					.getconnectionfrommethodprodback();
			List<ChannelModel> Chargefilemodel = new Vector<ChannelModel>();

			Statement stmt = connection.createStatement();

			ResultSet resultSet = stmt
					.executeQuery(GlobalVariables.ProdDbHealthquery);
			...
			emailstring = "<html><body> <p> This is report of the database health check for the Production receiver if you get details below please do check your db size and heatlh</p></br> Table as follows"
			...
			emailstring = emailstring
					+ "</table></br>"
					+ "<p>It seems that db helth is <b>"+dbheatlh+"</b></p>"
	...
	/*public static void main(String[] args) {
		Thread thread = new ProductionDBHealthcCheck();
		thread.run();
	}*/
